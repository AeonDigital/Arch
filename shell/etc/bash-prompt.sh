...
# ┌── $ rianna@archlinux in ~/DirName/SubDir
# └─> _
PRINTSTYLE03D="${NONE}${DGREY}\342\224\214\342\224\200\342\224\200${LBLUE} \$ ${WHITE}username${LBLUE}@${WHITE}host${LBLUE} in ${CYAN}~/atual/directory/path \n${DGREY}\342\224\224\342\224\200\076 ${NONE}"
PSTYLE03D="\[\e[40;01;30m\]\342\224\214\342\224\200\342\224\200\[\e[40;01;34m\] \$ \[\e[40;00;37m\]\u\[\e[40;01;34m\]@\[\e[40;00;37m\]\h\[\e[40;01;34m\] in \[\e[40;00;36m\]\w \n\[\e[40;01;30m\]\342\224\224\342\224\200\076 \[\e[40;00;37m\]"
